...
"[project]/Downloads/delegate/delegate/proxy.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$delegate$2f$delegate$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/delegate/delegate/node_modules/next/server.js [middleware] (ecmascript)");
;
const PROTECTED = [
    '/chat',
    '/permissions',
...
function proxy(req) {
    ...
    if (!isProtected) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$delegate$2f$delegate$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next();
    const session = req.cookies.get('appSession');
    if (!session) {
        const loginUrl = new URL('/api/auth/login', req.url);
        loginUrl.searchParams.set('returnTo', pathname);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$delegate$2f$delegate$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(loginUrl);
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$delegate$2f$delegate$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next();
}
const config = {
    matcher: [
        '/chat',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ucg-1_._.js.map